...
Tests MUST NOT call remote APIs (LLMs, external services) — mock all external dependencies.
...
### Tests for User Story 1 (backend services only — not frontend/API endpoints) ⚠️

> **NOTE: Write these tests FIRST, ensure they FAIL before implementation**
> **RULE: No remote API calls in tests — mock all external dependencies (LLMs, services)**
...
### Tests for User Story 2 (backend services only — not frontend/API endpoints) ⚠️
...
### Tests for User Story 3 (backend services only — not frontend/API endpoints) ⚠️
