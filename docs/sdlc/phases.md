...
Phase 01 puts lists in one place with ticks and proves the stack. Phase 02 takes on the hard part: finding and importing papers. Phase 03 closes the manual paths and completes Release 1. Phase 04 is a test gate. Phase 05 is Release 2, and starts only if phase 04 passes.
